...
class PacientesVarios:
    def __init__(self, builder):
        self.builder = builder

    def create_paciente(self, id, nombre, apellido, edad, genero, diagnostico, doctor):
...
class PacienteService:
    def __init__(self):
        ...
        self.hospital = PacientesVarios(self.builder)
